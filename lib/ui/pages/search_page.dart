...
import 'package:rick/bloc/character_bloc.dart';
import 'package:rick/data/models/character.dart';
import 'package:rick/ui/widgets/custom_list_tile.dart';
...
class _SearchPageState extends State<SearchPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        Padding(
          padding: const EdgeInsets.only(top: 15, bottom: 1, left: 15, right: 16 ),
          child: TextField(
